...
func (c *projectController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1.Project))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func (c *projectController) Create(obj *v1.Project) (*v1.Project, error) {
	result := &v1.Project{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *projectController) Update(obj *v1.Project) (*v1.Project, error) {
	result := &v1.Project{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *projectController) UpdateStatus(obj *v1.Project) (*v1.Project, error) {
	result := &v1.Project{}
...
func (c *projectController) Get(namespace, name string, options metav1.GetOptions) (*v1.Project, error) {
	result := &v1.Project{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *projectController) List(namespace string, opts metav1.ListOptions) (*v1.ProjectList, error) {
...
func (c *projectController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1.Project, error) {
	result := &v1.Project{}
...
func (c *projectCache) Get(namespace, name string) (*v1.Project, error) {
...
func (c *projectCache) List(namespace string, selector labels.Selector) (ret []*v1.Project, err error) {
...
func (c *projectCache) AddIndexer(indexName string, indexer ProjectIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1.Project))
		},
	}))
}

func (c *projectCache) GetByIndex(indexName, key string) (result []*v1.Project, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1.Project, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1.Project))
	}
	return result, nil
}
...
func (a *projectStatusHandler) sync(key string, obj *v1.Project) (*v1.Project, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *projectGeneratingHandler) Remove(key string, obj *v1.Project) (*v1.Project, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *projectGeneratingHandler) Handle(obj *v1.Project, status v1.ProjectStatus) (v1.ProjectStatus, error) {
